<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MerchantInfoAddressInfo.ascx.cs"
    Inherits="Tz888.Member.Controls.MerchantInfoAddressInfo" %>
    <!--添加的发布招商信息的提示部分-->   
   <!-- <div>
...
<table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
    ...
    <tr>
        ...
        <td width="638" valign="top">
            ...
            <span id="spTel" ></span>
            手机<asp:TextBox id='txtMobile' onchange="CAcheckNavigate(2)" width="127px" runat="server" /><span>（固定电话或手机至少填写一项）</span>       
        </td>
    </tr>
    <tr id="trswitchpublish" name="trswitchpublish">
        <td align="right" bgcolor="#F7F7F7">
