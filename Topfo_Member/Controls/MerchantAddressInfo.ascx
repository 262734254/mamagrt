<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MerchantAddressInfo.ascx.cs"
    Inherits="Tz888.Member.Controls.MerchantAddressInfo" %>
<table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
    <tr>
        <td align="left" colspan="2" class="lightc">
    ...
    <tr>
        ...
        <td width="638">
            ...
            <div class="clear"></div>
           <span class="hui"> 请填写该项目的直接负责人，姓名必填，手机选填</span>
    ...
    <tr>
        ...
        <td width="638">
            <asp:TextBox ID="txtEmail" onchange="CAcheckNavigate(4);" runat="server" size='18' Width="269px" /><br />
    ...
    <tr>
        ...
        <td width="638" valign="top">
            ...
            <asp:TextBox ID="txtTelNumber" onchange="CAcheckNavigate(5);" runat="server" size='18' /><br />
            <span id="spTel" ></span>
            <div class="clear"></div>
