<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CapitalAddressInfo.ascx.cs"
    Inherits="Tz888.Member.Controls.CapitalAddressInfo" %>
<table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
    <tr>
        <td colspan="2" align="left" class="lightc">
    ...
    <tr>
        ...
        <td width="638">
            ...
            <div class="clear"></div>
            <span class="hui" style="display:block;"> 您还没有发布投资机构信息，完整的投资机构介绍合作方更信任。<a href="/Publish/publishNavigate.aspx">点此立即发布</a></span></td>
    </tr>
    <tr>
