<%@ Page Language="C#" MasterPageFile="~/indexTof.master" AutoEventWireup="true" CodeFile="indexTof.aspx.cs" Inherits="indexTof" Title="Untitled Page" %>
...
function menu(n)
{
    ...
    <div class="member-right-left">
      <div class="per-infor">
        <ul>
          <li><span class="m-g-r"><img src="http://img2.topfo.com/member/images/member_33.jpg" width="16" height="14" /> 用户级别：<span class="f_cen" id="SpanGradeID" runat="server"></span></span> <img src="http://img2.topfo.com/member/images/member_35.jpg" width="13" height="14" /><span class="m-g-r f_cen" id="SpanTypeID" runat="server"></span> 会员到期时间：<span class="m-g-r f_cen" id="sVadate" runat="server"></span> </li>
       ...
       <div class="member-huiy1">
        ...
        <div class="member-huiy1-2">
         ...
         <ul>
          ...
          <li><img src="http://img2.topfo.com/member/images/mb-hy_13.jpg" align="absmiddle" /> <a href="Subject/SubjectSee.aspx">专题推广</a></li>
          ...
          <li><img src="http://img2.topfo.com/member/images/mb-hy_22.jpg" align="absmiddle" /> <a href="#">视频路演</a></li>
    ...
    <div class="member-right-right">
      ...
      <div class="member-right-right-1" >
        ...
        <div class="member-right-right-1-2" id="xa_con_1">
          <dl>
            <dt>网络合作</dt><dd>· 电话：0755-89805588-8028 </dd><dd>· 联系人：黄先生</dd><dd>· 邮箱： hyh@topfo.com </dd></dl>
          <dl>
