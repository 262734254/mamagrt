...
using Tz888.BLL;
public partial class helper_getPromotion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        AjaxPro.Utility.RegisterTypeForAjax(typeof(helper_getPromotion));
    ...
    {
        double money = Convert.ToDouble(obj);
        double count = money * 0.8;
        string str = "￥"+count.ToString("0.00");
        return str.ToString();
    }
    ...
    protected string GetCount(object count,object InfoID)
    {
        double money =Convert.ToDouble(count);
        
        long infoId =(long)InfoID;
        string str = "";
        if (money<=0)
        {
            str = "---";
        ...
        {
            str = "<a href=\"http://pay.topfo.com/order_item.aspx?InfoID=" + infoId + "\">购买</a>";
        }
        return str;
    }
    public void bind()
