...
public partial class helper_MatchingInfo : System.Web.UI.Page
{
    ...
    private void forPageLoad()
    {
        ...
        else
        {
            ...
            GridView1.DataBind();
            showMessage.InnerHtml = "·如果您无暇上网，又担心错过了好机会，请进行免费订阅设置。<br/>·第一时间抢占先机，万千财富滚滚来！ <br /> ·您是拓富通会员，享有无限数量的免费订阅权限";
            forReg.InnerHtml = "";
    ...
    public string GetTitleUrl(object id, object customType)
    {
        ...
        {
            return "MachingMessage.aspx?ID=" + id + "&type=" + customType;
        }
