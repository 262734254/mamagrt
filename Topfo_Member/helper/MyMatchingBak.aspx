...
<div class="mainconbox">
        ...
        <div class=" cshibiank">
            <div class="subtopt">
                <ul>
                    <li id="li0" onclick="Valuechange(0)" style="cursor:pointer">政府招商</li><li
                        id="li1" onclick="Valuechange(1)" style="cursor:pointer">资 本</li><li
                            id="li2" onclick="Valuechange(2)" style="cursor:pointer">项 目</li><li
                                id="li3" onclick="Valuechange(3)" style="cursor:pointer">创 业</li><li
                                    id="li4" onclick="Valuechange(4)" style="cursor:pointer">商 机</li><li
                                        id="li5" onclick="Valuechange(5)" style="cursor:pointer">资 讯</li></ul>
            </div>
            <div class="blank6">
            </div>
            <div class="subtab">
              <table id="ff" cellspacing="0" cellpadding="0" width="96%" align="center" border="0">
                    ...
                    <tr>
                        <td align="center" class="bxian">
                            <table id="pnlCapitalType" cellspacing="0" cellpadding="0" width="96%" border="0">
                                <tr>
                                    <td width="16%" align="right" class="12g">
                                        <asp:Label ID="lbtype" runat="server" Text="投资类别："></asp:Label>                                    </td>
                                    <td width="84%" align="left">
                                        <font face="Arial, Helvetica, sans-serif">
                    ...
                    <tr>
                        <td align="right" class="bxian" style="width: 17%; height: 22px;">
                            <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="16%" align="right">发布时间：</td>
                    ...
                    <tr align="center">
                        <td align="center" style="height: 97px">
                            ...
                            <asp:Button CssClass="buttomal" ID="butSelect" runat="server" Text="搜 索" OnClick="butSelect_Click">                            </asp:Button>
                            &nbsp;
                            <asp:Button CssClass="buttomal" ID="btnAdd" runat="server" Text="订 阅" OnClick="btnAdd_Click">                            </asp:Button></td>
                    </tr>
                </table>
                <div class="blank20">
                </div>
