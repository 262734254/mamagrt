...
using Tz888.Model;
using Tz888.Pager;
public partial class helper_TestMachingMessage : Tz888.Common.Pager.BasePage
{
    ...
    public string isMianFei(object obj, object isA, object InfoID)
    {
        ...
        if (obj != null)
        {
            ...
            else
            {
                if (isA.ToString() == "a")
                {
                    returnStr = "<a style='text-decoration:none;' id='hlType2' target='_blank' href='../PayManage/order_item.aspx?InfoID=" + InfoID + "'>立即购买</a>";
                }
                else
                {
