<%@ Page Language="C#" AutoEventWireup="true" ResponseEncoding="GB2312" MasterPageFile="~/MasterPage.master"
    Title="通知设置-拓富中心-中国招商投资网" CodeFile="getPromotion.aspx.cs" Inherits="helper_getPromotion" %>
                        ...
                        <asp:Repeater runat="server" ID="myList" OnItemCommand="myList_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="left" class="taba">
                                        ...
                                        <asp:LinkButton ID="lbtnDel" runat="server" CommandArgument='<%#Eval("InfoID") %>' CommandName="Delete" OnClientClick="return del()" Text="删除" />&nbsp;<%#GetCount(Eval("MainPointCount"), Eval("InfoID"))%></td>
                                 </tr>
                            </ItemTemplate>
                            <AlternatingItemTemplate>
                                <tr>
                                    ...
                                    <td align="left" class="taba">
                                        <a target="_blank" href="http://www.topfo.com/<%#Eval("HtmlFile") %>">查看</a>&nbsp;
                                        <asp:LinkButton ID="lbtnDel1" runat="server" CommandArgument='<%#Eval("InfoID") %>' CommandName="Delete" OnClientClick="return del()" Text="删除" />&nbsp;<%#GetCount(Eval("MainPointCount"), Eval("InfoID"))%>
                                     </td>
                                </tr>
                            </AlternatingItemTemplate>
                        </asp:Repeater>
