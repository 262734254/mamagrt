<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    ResponseEncoding="GB2312" CodeFile="InfoView.aspx.cs" Inherits="helper_FriendManager_InfoView"
        ...
        <div id="ListDiv">
            ...
            <div class=" cshibiank">
                ...
                <asp:GridView ID="friendAttentionGridView" runat="server" AutoGenerateColumns="False"
                    Width="756px" OnRowDataBound="friendAttentionGridView_RowDataBound">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <input type="checkbox" name="checkbox3" id="checkbox2" value='' />
                            </ItemTemplate>
                            <HeaderTemplate>
                        ...
                        <asp:TemplateField HeaderText="会员名称">
                            ...
                            <ItemTemplate>
                                <a href="<%#viewLink(Eval("LoginName"),Eval("View_ID"))%>" target="_blank">
                                    <%#view(Eval("LoginName"))%>
                                </a>
                        ...
                        <asp:BoundField HeaderText="查看时间">
                            <HeaderStyle CssClass="tabtitle" HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="操作">
                            <HeaderStyle CssClass="tabtitle" Height="20px" Wrap="False" HorizontalAlign="Center" />
                            <ItemTemplate>
                                <asp:Button ID="Button1" runat="server" BackColor="White" BorderStyle="None" CssClass="lanlink"
                                    Font-Overline="False" Font-Underline="True" ForeColor="RoyalBlue" Height="17px"
                                    Text="购买" Width="51px" OnClick="Button1_Click" />
            ...
            <div class="suggestbox " style="display: none">
                ...
                <p>
                    ...
                    <a href="http://www.topfo.com/web13/help/TopfoServer.shtml#a5">了解拓富通更多特权</a>0755-89805558
                </p>
            </div>
        </div>
    </div>
