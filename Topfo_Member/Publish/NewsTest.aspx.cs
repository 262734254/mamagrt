...
public partial class Publish_NewsTest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            //ViewState["Criteria"] = "AuditingStatus='"+id+"' and LoginName='" + Page.User.Identity.Name.ToString() + "'";//审核通过的资讯
            ViewState["Criteria"] = "AuditingStatus='" + id + "' and LoginName='262734254'";
    ...
    private void GetInfoNews()
    {
        ...
        DataSet ds = srvSI.dsGetNewsList("*", ViewState["Criteria"].ToString(), "publishT desc", CurrentPage, PageNum, out TotalCount);
        ...
        foreach (DataRow dr in ds.Tables[0].Rows)
        {
            ...
            drs["href"] = MerchantDomain + "/InfoDetail.aspx?id=" + dr["InfoID"].ToString();
    ...
    protected void btnSelect_Click(object sender, EventArgs e)
    {
        ...
        if (this.txtKeyWord.Value.Trim() != "" && this.ddlKind.SelectedValue == "1")
            ViewState["Criteria"] += " and Title like  '%" + this.txtKeyWord.Value.Trim() + "%' or Content like '%" + this.txtKeyWord.Value.Trim() + "%' or KeyWord like '%" + this.txtKeyWord.Value.Trim() + "%'";
        if (this.txtKeyWord.Value.Trim() != "" && this.ddlKind.SelectedValue == "2")
            ViewState["Criteria"] += " and Title like '%" + this.txtKeyWord.Value.Trim() + "%'";
        ...
        {
            ViewState["Criteria"] += " and NewsTypeID=" + this.ddlType.SelectedValue.ToString().Trim();
        }
