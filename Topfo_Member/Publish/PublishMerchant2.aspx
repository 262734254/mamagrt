<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PublishMerchant2.aspx.cs" ValidateRequest="false" Inherits="Publish_PublishMerchant2" Title="招商需求-发布招商需求" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
            ...
            <tr>
                ...
                <td width="618">
                    ...
                    <span id="spMerchantTypeInfo" class="hui"></span>
            ...
            <tr>
                <td align="right" bgcolor="#F7F7F7" style="height: 23px">
            ...
            <tr>
                ...
                <td width="618" valign="top">
                    <textarea id="txtZoneAboutBrief" onchange="checkZoneAbout();" runat="server" cols="50"
                        rows="10" style="width: 558px; height:78px"></textarea><span id="spZoneAbout"></span>
                            <br />
              ...
              <tr>
                ...
                <td width="618" valign="top">
                    <textarea id="txtZoneAbout" onchange="checkZoneAboutB();" runat="server" cols="50"
                        rows="10" style="width: 558px; height:78px"></textarea><span id="spZoneAboutB"></span>
              ...
              <tr>
                ...
                <td width="618" valign="top">
                    <textarea id="txtEconomicIndicators" onchange="checkZoneAboutJ();" runat="server" cols="50"
                        rows="10" style="width: 558px; height:110px"></textarea><span id="spZoneAboutC"></span>
                </td>
            </tr>
             ...
             <tr>
                ...
                <td width="618" valign="top">
                    <textarea id="txtInvestmentEnvironment" onchange="checkZoneAboutT();" runat="server" cols="50"
                        rows="10" style="width: 558px; height:110px"></textarea><span id="spZoneAboutD"></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="618" valign="top">
                    <textarea id="txtProjectStatus" onchange="checkZoneAboutX();" runat="server" cols="50"
                        rows="10" style="width: 558px; height:110px"></textarea><span id="spZoneAboutE"></span>
                </td>
            </tr>
             <tr>
                <td align="right" valign="top" bgcolor="#F7F7F7">
                ...
                <td width="618" valign="top">
                    <textarea id="txtMarket" onchange="checkZoneAboutY();" runat="server" cols="50"
                        rows="10" style="width: 558px; height:110px"></textarea><span id="spZoneaAboutF"></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="618" valign="top">
                    <textarea id="txtBenefit" onchange="checkZoneAboutZ();" runat="server" cols="50"
                        rows="10" style="width: 558px; height:110px"></textarea><span id="spZoneAboutG"></span>
                </td>
            </tr>
        ...
        <div class="blank0">
         ...
         <!--重新添加一个按纽记录上一步的值以上是注释部分-->
          <div id="nextDiv" style="display:block; text-align:center;">
              <input id="ShowInfo" type="button" value="下一步：确认联系方式" onclick="ShowContactInfo()" /></div>
         </div> 
         <!--招商基本信息的div结束处-->
      ...
      <asp:TextBox ID="ImageCode"  runat="server" Width="120px"></asp:TextBox> <img src="../ValidateNumber.aspx"  onclick="this.src='../ValidateNumber.aspx?temp=' + (new Date())" />
        ...
        <div class="mbbuttom">
           ...
           <a href="http://www.topfo.com/ServiceItem/ServiceItem.shtml" target="_blank">点此阅读中国招商投资网服务条款</a></p>
            <input type="button" id="preBtn" value="上一步" onclick="PreShow()" /> 
