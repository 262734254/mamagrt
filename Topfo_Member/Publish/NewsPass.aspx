<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="NewsPass.aspx.cs" Inherits="NewsPass" Title="已通过审核-资讯管理" %>
        ...
        else
        {
            if(op == "删除")
                if(confirm("删除后将无法恢复，您确定要删除？"))
                {
                    ...
                    frm.action = "NewsPass.aspx?op=del";
                    frm.submit();
                }  
        } 
        return true;
...
<div><ul class="handtop">
  ...
  <li class="liwai"><a href="NewsPass.aspx">已通过审核</a></li><li> <a href="NewsNopass.aspx">未通过审核</a> </li> 
</ul>
</div>
<div class=" cshibiank">
<div class="search">
<div class="leight30 ">您共有 <span class="hong">
    <asp:Label ID="LblCount" runat="server" Text=""></asp:Label></span> 条已通过审核的资讯 </div>
  <div class="lefts" style="width: 737px">资讯筛选：<asp:DropDownList ID="ddlTime" runat="server">
...
<asp:GridView ID="GridView1" DataKeyNames="InfoID" runat="server" Height="100%" width="100%" AutoGenerateColumns="False" PageSize="4" OnRowCommand="GridView1_RowCommand"
    ...
    <div id="NoMessage" style="display:none; height:100px;" runat="server" >
        您共有<strong><span style="color: #ff9900">0</span></strong>条已通过审核的资讯！<br /><a href="PublishNews.aspx">立即发布资讯</a>
</div>
</div>
<div class="pagebox">
