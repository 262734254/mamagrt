<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PublishCapital1.aspx.cs" EnableEventValidation="false"
 ValidateRequest="false" Inherits="Publish_PublishCapital" Title="投资需求-发布投资需求" %>
...
function switchPublish()
{
    ...
    <div class="mainconbox">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tabbiank">
                ...
                <td width="625">
                    <strong>
                        <asp:TextBox ID="txtCapitalName" onchange="JavaScrpit:checkCapitalName()" runat="server"
                            Width="299px"></asp:TextBox></strong> <span id="spCapitalName2"></span>
                </td>
            </tr>
            <tr>
            ...
            <tr id="trswitchpublish2" name="trswitchpublish">
              ...
              <td width="625" valign="top">
                    ...
                    <br />
                  <span id="spKeyMsg"></span><span class="hui">用户现在更多地通过搜索来寻找资源，定义相关的关键字能让您的需求更容易被项目方找到。</span>   <a href="http://www.topfo.com/help/demandmanage.shtml#19" target="_blank" >如何定义关键字</a>                </td>
            </tr>
        ...
        <div class="mbbuttom">
            <p>
                <a href="http://www.topfo.com/ServiceItem/ServiceItem.shtml" target="_blank" >点此阅读中国招商投资网服务条款</a><span><a href="#" class="lanlink">查询是否属于重复信息</a></span></p>
