<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"  Title="已通过审核-图片管理" CodeFile="PicturePass.aspx.cs" Inherits="PicturePass" %>
        ...
        else
        {
            if(op == "删除")
                if(confirm("删除后将无法恢复，您确定要删除？"))
                {
                    ...
                    frm.action = "PicturePass.aspx?op=del";
                    frm.submit();
                }  
        } 
        return true;
...
<div><ul class="handtop">
  <li ><a href="PictureAudit.aspx">审核中</a>  </li>
  <li class="liwai"><a href="PicturePass.aspx">已通过审核</a></li><li> <a href="PictureNoPass.aspx">未通过审核</a> </li> 
</ul>
</div>
<div class=" cshibiank">
<div class="search">
<div class="leight30 ">您共有 <span class="hong">
    <asp:Label ID="LblCount" runat="server" Text=""></asp:Label></span> 条已通过审核的图片 </div>
...
<asp:GridView ID="GridView1" DataKeyNames="InfoID" runat="server" Height="100%" width="100%" AutoGenerateColumns="False" PageSize="4" OnRowCommand="GridView1_RowCommand"
        ...
        <Columns>  
          <asp:TemplateField>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Image runat="server" ImageUrl='<%#((System.Data.DataRowView)Container.DataItem)["MiniatureUrl"]%>' /> 
                </ItemTemplate>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <a href="<%#((System.Data.DataRowView)Container.DataItem)["href"] %>" target="_blank">
                    <%#((System.Data.DataRowView)Container.DataItem)["Title"]%></a>
                    <%#((System.Data.DataRowView)Container.DataItem)["publishT"]%> 
                </ItemTemplate> 
                <HeaderStyle HorizontalAlign="Left" />
            </asp:TemplateField>  
    ...
    <div id="NoMessage" style="display:none; height:100px;" runat="server" >
        您共有<strong><span style="color: #ff9900">0</span></strong>条已通过审核的图片！<br /><a href="PublishNews.aspx">立即上传图片</a>
</div>
</div>
<div class="pagebox">
