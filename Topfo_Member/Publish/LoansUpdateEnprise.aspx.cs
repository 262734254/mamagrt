...
public partial class Publish_LoansUpdateEnprise : System.Web.UI.Page
{
    ...
    private void BindShow()
    {
        ...
        txtenpricename.Text = loanscontactstab.EnterpriseName.ToString();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        //联系方式
        loanscontactstab.EnterpriseName = txtenpricename.Text.Trim();
        ...
        if (resultrow2 > 0 && resultrow2 > 0 && resultrow2 > 0)
        {
