    <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" EnableViewStateMac="false" CodeFile="NewsAudit.aspx.cs" Inherits="NewsAudit" Title="审核中-资讯管理" %>
...
<div><ul class="handtop">
  <li class="liwai"><a href="NewsAudit.aspx">审核中</a>  </li>
  <li><a href="NewsPass.aspx">已通过审核</a></li><li> <a href="NewsNopass.aspx">未通过审核</a> </li> 
</ul>
</div>
<div class=" cshibiank">
<div class="search">
<div class="leight30 ">您共有 <span class="hong">
    <asp:Label ID="LblCount" runat="server" Text=""></asp:Label></span> 条审核中的资讯 </div>
  <div class="lefts" style="width: 735px">资讯筛选：<asp:DropDownList ID="ddlTime" runat="server">
...
<asp:GridView ID="GridView1" DataKeyNames="InfoID" runat="server" Height="100%" width="100%" AutoGenerateColumns="False" PageSize="4" OnRowCommand="GridView1_RowCommand"
        ...
        <Columns>  
          <asp:TemplateField>
                <HeaderTemplate>全选</HeaderTemplate>
                <ItemTemplate>
    ...
    <div id="NoMessage" style="display:none;height:100px;" runat="server" >
        您共有<strong><span style="color: #ff9900">0</span></strong>条正在审核中的资讯！<br /><a href="PublishNews.aspx">立即发布资讯</a>
</div>
</div>
<div class="pagebox">
