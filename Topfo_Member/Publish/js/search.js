...
function ChangeSearchKeyword(index){
	...
	{
		case 0 : //全部
			PostURL = "http://search.topfo.com/AllResource.aspx";
			document.getElementById("form_Search").action = PostURL;
			ChangeKeyWord(theKeyWord,"");
			break;
		case 1 : //投资
			PostURL = "http://search.topfo.com/CapitalResource.aspx";
			document.getElementById("form_Search").action = PostURL;
			ChangeKeyWord(theKeyWord,"资本");
			break;
		case 2 : //融资
			PostURL = "http://search.topfo.com/ProjectResource.aspx";
			document.getElementById("form_Search").action = PostURL;
			ChangeKeyWord(theKeyWord,"企业项目");
			break;
		case 3 : //招商
			PostURL = "http://search.topfo.com/MerchantResource.aspx";
			document.getElementById("form_Search").action = PostURL;
