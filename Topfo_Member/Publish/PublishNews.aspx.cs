...
public partial class PublishNews : System.Web.UI.Page
{
    ...
    {
         fbID = Convert.ToInt32(Request["id"]);
    ...
    private void Check()
    {
        if (fbID == 1)
        {
            this.radioType01.Checked = true;
        }
        else if (fbID == 2)
        {
            this.radioType64.Checked = true;
        }
        else if (fbID == 3)
        {
            this.radioType65.Checked = true;
        }
        else if (fbID == 4)
        {
            this.radioType66.Checked = true;
        }
        else if (fbID == 5)
        {
            tb1.Style["display"] = "none";
            dvpublish2.Style["display"] = "block";
            this.radioType67.Checked = true;
        }
