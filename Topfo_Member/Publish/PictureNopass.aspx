<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Title="审核未通过-图片管理" CodeFile="PictureNopass.aspx.cs" Inherits="PictureNopass" %>
        ...
        else
        {
            if(op == "删除")
                if(confirm("删除后将无法恢复，您确定要删除？"))
                {
                    ...
                    frm.action = "PictureNoPass.aspx?op=del";
                    frm.submit();
                }  
        } 
        return true;
...
<div><ul class="handtop">
  ...
  <li ><a href="PicturePass.aspx">已通过审核</a></li><li class="liwai"> <a href="PictureNoPass.aspx">未通过审核</a> </li> 
</ul>
</div>
<div class=" cshibiank">
<div class="search">
<div class="leight30 ">您共有 <span class="hong">
    <asp:Label ID="LblCount" runat="server" Text=""></asp:Label></span> 条未通过审核的图片 </div>
...
<asp:GridView ID="GridView1" DataKeyNames="InfoID" runat="server" Height="100%" width="100%" AutoGenerateColumns="False" PageSize="4" OnRowCommand="GridView1_RowCommand"
        ...
        <Columns>  
          <asp:TemplateField>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Image ID="Image1" runat="server" ImageUrl='<%#((System.Data.DataRowView)Container.DataItem)["MiniatureUrl"]%>' /> 
                </ItemTemplate>
    ...
    <div id="NoMessage" style="display:none; height:100px;" runat="server" >
        您共有<strong><span style="color: #ff9900">0</span></strong>条未通过审核的图片！<br /><a href="PublishNews.aspx">立即上传图片</a>
</div>
</div>
<div class="pagebox">
