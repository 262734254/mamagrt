<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Title="图片更新" CodeFile="UpdatePicture.aspx.cs" Inherits="UpdatePicture" %> 
...
<tr>
  ...
  <tr>
    ...
    <td width="606"><label>
      <input name="radioType" type="radio" value="转载" checked="true" onclick="checkedTypeOK()" id="radioType1" runat="server"/>
      </label> 
      转载 
      <input type="radio" name="radioType" value="原创"  onclick="checkedTypeOK()" id="radioType2" runat="server"/>
      原创<label></label></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top"><textarea name="txtContent" cols="80" rows="12" id="txtContent" runat="server"></textarea>
      <br />
      <span class="hui">图片简介不超过500个汉字</span></td>
  </tr>
  <tr>
