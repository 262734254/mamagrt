<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PublishMerchant1.aspx.cs" Inherits="Publish_PublishMerchant" ValidateRequest="false" Title="Untitled Page" %>
     ...
     document.getElementById(id).src = "../../ValidateNumber.aspx?r="+Math.random();
        ...
        function TopFo()
        {
          ...
          if(GetCheckNum(rdlValiditeTermID.replace(/_/g,"$")) <= 0)
            ...
            if(document.getElementById("ctl00_ContentPlaceHolder1_ZoneSelectControl1_hideCountryCode").value=="CN")
            {
      ...
      <tr>
          ...
          <span class="hong">*</span>总投资：</td>
                <td>
                    ...
                    <asp:TextBox ID="txtCapitalTotal"   runat="server" MaxLength="5"
                        Width="75px" onkeyup="value=value.replace(/[^\d]/g,'') "></asp:TextBox>
                    万元 <span id="spCapitalTotal"></span>   </td>
          </tr>
            <tr>
                <td class="publica-td-left">
                   <span class="hong"></span> 回报率：</td>
                <td >
                    <asp:TextBox ID="txtHuiBao1" runat="server" Width="71px" MaxLength="4" onkeyup="value=value.replace(/[^\d]/g,'') "></asp:TextBox>%</td>
            </tr>
            <tr>
              <td class="publica-td-left">
    ...
    <tr>
      ...
      <input  type="text"   id="validCode" /> 
            ...
            <td colspan="2" id="pub-tongyi">
             ...
             <asp:ImageButton ID="IbtnSubmit"  OnClientClick="return TopFo();" ImageUrl="http://img2.topfo.com/member/images/member-btn-tj.jpg" runat="server"
