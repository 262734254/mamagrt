...
public partial class Publish_PublishMerchant : System.Web.UI.Page
{
    ...
    protected void IbtnSubmit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (txtHuiBao1.Text.ToString().Trim() == "")
        {
        ...
        if (infoID > 0)
        {
            ...
            string HtmlFile = "Merchant/" + DateTime.Now.ToString("yyyyMM") + "/Merchant" + DateTime.Now.ToString("yyyyMMdd") + "_" + infoID + ".shtml";
