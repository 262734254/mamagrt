<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LoansInfoEnterprise.aspx.cs" Inherits="Publish_LoansInfoEnterprise" Title="Untitled Page" %>
...
<link href="http://img2.topfo.com/member/css/payment.css" rel="stylesheet" type="text/css" />
    ...
    <script type ="text/javascript" language ="javascript" src ="../Register/Js/JScriptInsertenprice.js" ></script>
    <script language ="javascript" type="text/javascript" >
    </script>
  <div class="publication">
      <h1><span class="fl"><span class="f_14px strong f_cen">发布企业贷款需求</span>(带<span class="hong">*</span>为必填项)</span><span class="fr"><img src="http://img2.topfo.com/member/images/biao_01.gif" align="absMiddle"/> <a href="http://www.topfo.com/help/demandrelease.shtml#16" class="publica-fbxq">需求发布规则</a></span></h1>
        <table width="100%"  cellpadding="0" cellspacing="0"  class="publica">
          ...
          <tr><td colspan=2><span class="f_14px strong f_cen">联系方式：</span></td></tr>
                ...
                <td width="625">
                    <strong>
                        <asp:TextBox ID="txtentriname" onblur="outpostcode(this,'showentiypename')" runat="server"
                            Width="299px"></asp:TextBox></strong> &nbsp;<div id="showentiypename" style ="display:none; color:Red ; font-size:12px">*</div>
                </td>
            </tr>
            <tr>
                <td width="133" align="right" >
     ...
     <!-- </label>-->
      ...
      <asp:ImageButton ID="IbtnSubmit" ImageUrl="http://img2.topfo.com/member/images/member-btn-tj.jpg" runat="server"
             OnClientClick="return checkinsertss()"    OnClick="IbtnSubmit_Click" /></td></tr>
        </table>
    </div>
