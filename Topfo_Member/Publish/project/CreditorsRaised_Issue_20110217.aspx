<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CreditorsRaised_Issue_20110217.aspx.cs" Inherits="Publish_project_CreditorsRaised_Issue"
    Title="Untitled Page" %>
    ...
    <div id="step1" style="display: block;">
        ...
        <table cellspacing="0" class="mem_tab1">
           ...
           <%-- <tr>
            ...
            <tr>
                <td class="tdbg" style="width: 145px">
                    <span class="f_red">*</span> <span style="font-size: 10.5pt; font-family: 宋体; mso-bidi-font-size: 11.0pt;
                        mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri; mso-bidi-font-family: 'Times New Roman';
                        mso-font-kerning: 1.0pt; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN;
                        mso-bidi-language: AR-SA"></span><strong>可接收资金成本上限：</strong></td>
                <td>
        ...
        <table width="100%" cellspacing="0" style="height: 50px; text-align: center;">
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnIssueOK" runat="server" Text="确认发布"   OnClientClick="chkpost();" OnClick="btnIssueOK_Click" />
                </td>
            </tr>
        </table>
    </div>
