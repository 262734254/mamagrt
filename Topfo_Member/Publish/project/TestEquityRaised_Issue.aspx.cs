...
public partial class Publish_project_TestEquityRaised_Issue : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.ViewState["LoginMemberName"] = "huarun1688";
            //会员信息表
    ...
    {
        //转到债券融资_发布
        Response.Redirect("CreditorsRaised_Issue.aspx?fid=1", true);
    }
    ...
    {
        string loginName = "huarun1688";  //Page.User.Identity.Name;
    ...
    private void InsertData()
    {
        ...
        mainInfoModel.LoginName = "huarun1688"; // Page.User.Identity.Name;
