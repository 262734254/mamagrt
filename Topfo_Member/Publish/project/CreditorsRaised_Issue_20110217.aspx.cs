...
public partial class Publish_project_CreditorsRaised_Issue : System.Web.UI.Page
{
    ...
    protected void btnIssueOK_Click(object sender, EventArgs e)
    {
        ...
        //产品市场增长率
        projectInfoModel.iZqCpsczzl = 0;// Tz888.Common.Text.FormatData(tbCpsczzl.Value.Trim());
        //产品市场容量
        projectInfoModel.iZqCpscYl = 0;// Tz888.Common.Text.FormatData(tbCpscyl.Value.Trim());
        //资产负债率
        projectInfoModel.iZqZcfzl = 0;// Tz888.Common.Text.FormatData(tbZcfzl.Value.Trim());
        //流动比率
        projectInfoModel.iZqYdbl = 0;// Tz888.Common.Text.FormatData(tbLdbl.Value.Trim());
        //投资收益率
        projectInfoModel.iZqTzsl = 0;// Tz888.Common.Text.FormatData(tbTzsyl.Value.Trim());
        //销售利润率
        projectInfoModel.iZqXslyl = 0;// Tz888.Common.Text.FormatData(tbXslyl.Value.Trim());
        //投资回报期
        projectInfoModel.iZqTzfbq = 0;// Tz888.Common.Text.FormatData(rblXmtzfbzq.SelectedValue.Trim());
        //项目有效期限
        projectInfoModel.iZqXmyxqs = Tz888.Common.Text.FormatData(rblXmyxqxx.SelectedValue.Trim());
        //项目摘要
        projectInfoModel.ComBrief = "";// Tz888.Common.Utility.PageValidate.TxtToHtml(tbXmzy.Value.Trim());
        //项目关键字 textbox
        //string strXmgjz = "";
        ...
        //##项目详细资料
        //*借款单位年营业收入
        projectInfoModel.nDwlyysy = 0;// Tz888.Common.Text.FormatDecimal(tbJkdwlyysy.Value.Trim());
        //*借款单位年净利润
        projectInfoModel.nDwljly = 0;// Tz888.Common.Text.FormatDecimal(tbJkdwljly.Value.Trim());
        //*借款单位总资产
        projectInfoModel.nDwzzc = 0;// Tz888.Common.Text.FormatDecimal(tbJkdwzzc.Value.Trim());
        //*借款单位总负债
        projectInfoModel.nDwzfz = 0;// Tz888.Common.Text.FormatDecimal(tbJkdwzfz.Value.Trim());
