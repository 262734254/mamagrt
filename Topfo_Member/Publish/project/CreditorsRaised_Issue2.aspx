<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreditorsRaised_Issue2.aspx.cs" Inherits="Publish_project_CreditorsRaised_Issue2" Title="Untitled Page" %>
...
<table width="100%" height="60" border="0" cellpadding="0" cellspacing="0" style="text-align:center; line-height:20px; margin:15px 0;" class="f_14">
  <tr>
    ...
    <td width="50"><img src="../../img/member_icon1.gif" /></td>
