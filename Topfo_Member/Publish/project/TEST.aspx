<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TEST.aspx.cs" Inherits="Publish_project_TEST" %>
...
//        var tb=document.getElementById("tbXmqxms");
         if(document.getElementById("tbXmqxms").value=="")
	   {
	       alert("项目介不能为空！");
	       tb.focus();
	       return false;
...
//       if(document.getElementById("ImageCode").value !='<%=Session["valationNo"] %>')
