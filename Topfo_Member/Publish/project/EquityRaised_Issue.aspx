...
//////////////////////////
   ...
   <div class="member-right">
    <div class="publication">
      <h1><span class="fl"><span class="f_14px strong f_cen">发布股权融资需求</span>(带<span class="hong">*</span>为必填项)</span><span class="fr"><img src="http://img2.topfo.com/member/images/biao_01.gif" align="absMiddle"/> <a href="http://www.topfo.com/help/demandrelease.shtml#16" class="publica-fbxq">需求发布规则</a></span></h1>
...
<input id="txtCapitalTotal" type="text"  runat="server" maxlength="15"  width="75px"  onblur="repl(this);" onkeyup="value=value.replace(/[^\d]/g,'') "  />
            ...
            <tr>
              ...
              <span class="hong">*</span>融资金额：</td>
                ...
                <asp:RadioButtonList ID="rbtnCapital" runat="server" RepeatDirection="Horizontal"
                            ...
                            <input name="ZoneId1" type="text" id="rzje" style="width:0; border-color:#FFFFFF;border:1px solid #FFFFFF" />
                      </td>
            </tr>
            <tr>
             <td class="publica-td-left" >
         ...
         <input name="ZoneId" type="text" id="XmyxqxxID" style="width:0; border-color:#FFFFFF;border:1px solid #FFFFFF" />
            ...
            <tr>
             <td class="publica-td-left" >
                ...
                <td width="618">
                    <textarea id="txtProIntro" runat="server" cols="50" style="width: 558px; height: 153px" onblur="repl(this);" ></textarea><span
                                id="spProIntro"></span>
        <br />
                    </td>
            </tr>
            <tr>
             <td class="publica-td-left" >
                ...
                <td width="618">
                    <textarea id="txtXmqxms" runat="server" cols="50" style="width: 558px; height: 149px" onblur="repl(this);"></textarea>
                    </td>
            </tr>
            <tr>
             <td class="publica-td-left" >
                   管理团队：</td>
                <td width="618">
                    <textarea id="txtManageTeamAbout" cols="50"  rows="5" style="width:80%" runat="server" onblur="repl(this);"></textarea>
                    </td>
            </tr>
          <tr>
      ...
      <td><input id="txtCareer" class="show" type="text" style="width: 210px" runat="server" maxlength="12"   onblur="repl(this);" />
    ...
    <tr >
        ...
        <td >
            <input id="txtMobile" class="show" maxlength="11" type="text" style="width: 210px"
                        runat="server" />  <span class="f_gray">（固定电话或手机至少填写一项）</span>
        </td>
    </tr>
    <tr >
        <td class="publica-td-left" >
...
<%--              <input name="" type="image" src="http://img2.topfo.com/member/images/member-btn-tj.jpg"  style="margin-top:6px"/>
              ...
              <asp:ImageButton ID="btnIssueOK"  OnClientClick="return chkpost();" ImageUrl="http://img2.topfo.com/member/images/member-btn-tj.jpg" runat="server"
