<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublishOppor2.aspx.cs" Inherits="Publish_PublishOppor2" %>
...
<script language="javascript" type="text/javascript">
	...
	function chkBtn()
	{
	   ...
	   var  rdlValiditeTermID="<%=this.rdbtXM.ClientID %>";
        ...
        {
           alert("项目有效期不能为空！");
           document.getElementById("rdlTerm").focus();
           return false;
        }
   ...
   <div class="mainconbox">
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="tabbiank" style="width: 751px">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <span id="Span9"></span>
                    <input name="ZoneId" type="text" id="IndustryId" style="width:0; border-color:#FFFFFF;border:1px solid #FFFFFF; height: 7px;" />
                </td>
            </tr>
            <tr align="left">
    ...
    <td valign="top">        
        <span class="hui" >
            ...
            <asp:Image ID="Image1" runat="server" Width="102px" Height="120px" /></td>
                </tr>
                <tr>
                    <td style="width: 27px; height: 15px;">
                    <input type="button" runat="server" id="btnUp1" value="上传" />
                    </td>
                    <td style="width: 26px; height: 15px;">
                    <input type="button" runat="server" id="btnQu" value="删除" />
                    </td>
                </tr>
            </table>
            <div style="display:none" id="divFile" runat="server">
            <asp:FileUpload ID="uploadPic" runat="server" Width="235px" Height="27px" />&nbsp;<asp:Button ID="btnUpload2"
