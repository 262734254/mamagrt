<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Title="审核中-视频管理" CodeFile="VideoAudit.aspx.cs" Inherits="VideoAudit" %>
        ...
        else
        {
            if(op == "删除")
                if(confirm("删除后将无法恢复，您确定要删除？"))
                {
                    ...
                    frm.action = "VideoAudit.aspx?op=del";
                    frm.submit();
                }  
        } 
        return true;
...
<div><ul class="handtop">
  <li class="liwai"><a href="VideoAudit.aspx">审核中</a>  </li>
  <li><a href="VideoPass.aspx">已通过审核</a></li><li> <a href="VideoNopass.aspx">未通过审核</a> </li> 
</ul>
</div>
<div class=" cshibiank">
<div class="search">
<div class="leight30 ">您共有 <span class="hong">
    <asp:Label ID="LblCount" runat="server" Text=""></asp:Label></span> 条审核中的视频
</div>
...
<asp:GridView ID="GridView1" DataKeyNames="InfoID" runat="server" Height="100%" width="100%" AutoGenerateColumns="False" PageSize="4" OnRowCommand="GridView1_RowCommand"
    ...
    <div id="NoMessage" style="display:none; height:100px;" runat="server" >
        您共有<strong><span style="color: #ff9900">0</span></strong>条正在审核中的视频！<br /><a href="PublishVideo.aspx">立即上传视频</a>
</div>
</div>
<div class="pagebox">
