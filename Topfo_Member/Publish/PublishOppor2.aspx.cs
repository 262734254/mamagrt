...
public partial class Publish_PublishOppor2 : System.Web.UI.Page
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        if (this.uploadPic.HasFile)
        {
            ...
            ccc = uploadPic.PostedFile.FileName;
            ccc = ccc.Substring(ccc.LastIndexOf("\\") + 1); ;
            string name = Request.PhysicalApplicationPath + "ImgUpload" + "\\" + ccc;
            string name1 = Request.PhysicalApplicationPath + "ImgUpload" + "\\" + "s_" + ccc;
            uploadPic.PostedFile.SaveAs(name);

            Tz888.Common.FileHelper.MakeThumbnail(name, name1, 102, 120, "Cut");
            switch (picTitle)
            {
            ...
            Image1.ImageUrl ="~\\"+ "ImgUpload" + "\\" + "s_" + ccc;
        }
        else
        {
       ...
       // txtpostID.Text = Convert.ToString(ViewState["strSavePath"]);
    }
}
