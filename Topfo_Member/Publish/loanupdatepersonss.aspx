<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="loanupdatepersonss.aspx.cs" Inherits="Publish_loanupdatepersonss" Title="Untitled Page" %>
...
<link href="http://img2.topfo.com/member/css/payment.css" rel="stylesheet" type="text/css" />
    ...
    <script type ="text/javascript" language ="javascript" src="../Register/Js/JScriptpersons.js"  ></script>
    <script language ="javascript" type="text/javascript" >

    </script>

  <div class="publication">
      <h1><span class="fl"><span class="f_14px strong f_cen">修改个人贷款</span>(带<span class="hong">*</span>为必填项)</span><span class="fr"><img src="http://img2.topfo.com/member/images/biao_01.gif" align="absMiddle"/> <a href="http://www.topfo.com/help/demandrelease.shtml#16" class="publica-fbxq">需求发布规则</a></span></h1>
        <table width="100%"  cellpadding="0" cellspacing="0"  class="publica">
            <tr>
                <td width="133" align="right" >
                    <span class="hong">*</span> <strong>借款标题：</strong></td>
                <td width="625">
                    <strong>
            ...
            <tr id="trids"  runat="server" visible="false">
                <td width="133" align="right" >
                    <span class="hong">* </span><strong>还款方式：</strong></td>
                <td align="left" width="625">
                    <asp:RadioButtonList ID="radiohaiMoney" runat="server" RepeatLayout="Flow" RepeatDirection="Horizontal">
...
<tr><td colspan=2> <span class="f_14px strong f_cen">联系方式：</span></td></tr>
         ...
         <tr><td colspan=2 align="center"><asp:Button ID="btnUpdate" runat="server" OnClientClick="return ches()"  OnClick="btnUpdate_Click" Text="修 改" /></td></tr>
