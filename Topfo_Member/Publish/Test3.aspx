<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test3.aspx.cs" Inherits="Publish_Test3" %>
...
<table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
  <tr>
    <td align="right" bgcolor="#F7F7F7" style="width: 158px; height: 22px;"><span class="hong">* </span><strong>资讯类别：</strong></td>
    <td width="606" style="height: 22px"> 
      <input name="radioType" type="radio" value="01" checked="true" id="radioType01" runat="server"    onclick="checkedTypeOK()"/>   
...
<td width="608" valign="top"><menu class="menulw" style="width: 51px">国家</menu> <menu>城市区号</menu><menu>电话号码</menu> <br />
...
<td width="608"><menu class="menulw" style="width: 53px">国家</menu> <menu>城市区号</menu><menu>
    传真号码</menu> <br />
