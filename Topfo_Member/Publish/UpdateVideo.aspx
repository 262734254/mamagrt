<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Title="视频更新" CodeFile="UpdateVideo.aspx.cs" Inherits="UpdateVideo" %>
...
<div class="suggestbox lightc allxian"><h1><strong>上传帮助</strong></h1>
  <p>1. 大小：所上传的视频文件大小不能超过200M。 <br />
    2. 时长：时长无限制。但5分钟以内的视频，可以达到最流畅的上传及观赏效果。 </p>
  3.  支持格式：支持wmv、asf、avi、mpg、dat的视频格式。</div>
...
<tr>
  ...
  <tr>
    ...
    <td width="606"><label>
      <input name="radioType" id="radioType1" type="radio" value="转载" checked="true" onclick="checkedTypeOK()"  runat="server"/>
      </label> 
      转载 
      <input type="radio" name="radioType" id="radioType2" value="原创"  onclick="checkedTypeOK()" runat="server"/>
      原创<label>
...
<div class="pad_1" align="center">
  <label>
  <input id="chkYes" name="chkYes" type="checkbox" value="checkbox" checked="checked" runat="server" />
   </label>
   我的视频符合Topfo的上传条款： <br />
