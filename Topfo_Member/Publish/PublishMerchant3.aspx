<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PublishMerchant3.aspx.cs" Inherits="Publish_PublishMerchant3" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<div class="member-right">
    <div class="publication">
      <h1><span class="fl"><span class="f_14px strong f_cen">发布政府招商需求</span></span><span class="fr pb-mg01"><img src="http://img2.topfo.com/member/images/biao_01.gif" align="absmiddle"/> <a href="http://www.topfo.com/help/demandrelease.shtml#16" target="_blank" class="publica-fbxq">需求发布规则</a></span></h1>
        ...
        <div class="fbcg">
         ...
         <div class="fbcg2 "> 
          我们为您找到了 <span id="spCount" class="hong">-</span> 条关于“<span><%=this.title %></span>”的匹配资源，或许您的机会就在这里！<a href="../Manage/PertinentLink.aspx?InfoID=<%=this._infoID %>&type=Merchant" class="lan1">点击查看</a>│<a href="/helper/MatchingInfo.aspx" class="lan1">定阅此类资源</a>
         </div>
           <div class="fbcg3"> 
            <h3>您还可以发布一下相关服务：</h3>
            <ul>
            ...
            <p class="f_14px f_black">您还可以联系我们专业的线下运作团队帮您解决招商问题，<a href="http://www.topfo.com/Aboutus/ServiceNet/MerchantService.shtml" target="_blank" class=" lan1">了解一下专业服务</a></p>
          </div>
        </div>
