...
public partial class PayManage_order_itemTest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            infoID = "2876649";// Request.QueryString["InfoID"];
            string loginname = "cn001"; //Page.User.Identity.Name; //tzWeb.LoginInfo.GetLoginUserName(0);
