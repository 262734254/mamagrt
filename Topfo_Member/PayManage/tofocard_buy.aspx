<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" Title="购买充值卡-拓富中心-中国招商投资网" CodeFile="tofocard_buy.aspx.cs"
       ...
       <div class="blank20">
        ...
        <div class="helpbox">
            <div class="con">
                ...
                <p>
                  <span class="hong">会员服务热线：<!--#include file="../common/custel.html"--></span> <a href="/ContactUs.shtml" target="_blank">在线客服</a></p>
            </div>
    </div>
	</div>
</asp:Content>
