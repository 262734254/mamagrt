<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QuickPay.aspx.cs" Inherits="PayManage_QuickPay_QuickPay" Title="Untitled Page" %>
...
<div class="payment2">
<h1>
  <span class="payment2-a">使用银联在线进行支付</span> <span >
    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"> 我想使用其他支付方式</asp:LinkButton></span></h1>
<div class="pagment2-liuc">
<ul>
<li class="f_12px">银联在线付款流程 </li>
<li>
 <img src="http://img2.topfo.com/member/img/payment2_07.jpg" /> <span class=" strong"><a href="#" class="f_cen">查看演示</a></span></li>
<li class="f_cen f_12px"> 提示：您银联账户余额必须大于您购买的资源价格，您才可以使用银联在线支付。</li>
</ul>
</div>
