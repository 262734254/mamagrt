<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Aajxstrike.aspx.cs" Inherits="PayManage_Aajxstrike" Title="Untitled Page" %>
...
<script language="javascript" type="text/javascript" src="../js/jquery.js"></script>
 ...
 function Hand(str,page,time,pay,name)
 {
   ...
   $.ajax({type:"get",url:"AajxTab.ashx",data:"name="+name+"&Strike="+str+"&page="+page+"&Type=1&payType="+pay+"&BegTime="+time+"",success:function(msg) 
   { 
 ...
 {
    $.ajax({type:"get",url:"AajxTab.ashx",data:"name="+name+"&Strike="+str+"&page="+page+"&Type=2&payType="+pay+"&BegTime="+time+"",success:function(msg) 
   { 
...
<asp:Button ID="btnSearch" runat="server" CssClass="btn-002"  Text="查 询" />
        ...
        <h2>
        <ul>
         <li  id="OrderT" onclick="Having(1,0)">充值订单管理</li>
         <li class="btn_on"  id="RecT" onclick="Having(0,0)">完成的充值</li>
         </ul>
        </h2>
