...
public partial class PayManage_trade_other_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        AjaxPro.Utility.RegisterTypeForAjax(typeof(PayManage_trade_other_list));
        loginname = Page.User.Identity.Name;
        if (!Page.IsPostBack)
        {
            ViewState["CurrPage"] = 1;
            ViewState["pagesize"] = 15;
            ViewState["strWhere"] = "PayStatus=1 and payStatus<>10 and BuyType<>'info' and BuyType<>'cz' and LoginName='" + loginname + "'";
            bind();
        }
    }
    public void bind()
    ...
    {
        Tz888.Common.MakeCriteria.AddCriteria(ref Criteria, "PayStatus=", "1", false, false);
