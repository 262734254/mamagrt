<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="orderBuy_item.aspx.cs" Inherits="PayManage_VipPay_orderBuy_item" Title="Untitled Page" %>
...
<ul>
    ...
    <table width="700" style="margin-left:auto; margin-right:auto; border: solid 2px #C33">
        <tr>
            <td colspan="3">
             <h3>
                 银行转账(直接汇款)
  ...
  <tr>
    <td width="52"><div align="center">[01]</div></td>
      ...
      帐　　号：6227 0072 0001 0552 018</td>
        ...
        <tr>
            ...
            <h3>
                ...
                <h3>
                    &nbsp; &nbsp;&nbsp; &nbsp;周小姐：18925252758  电话：86146728 &nbsp; 黄先生：18925252763 电话：89805588-8028</h3>
            </td>
        </tr>
</table>
