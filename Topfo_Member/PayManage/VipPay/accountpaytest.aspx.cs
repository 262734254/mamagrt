...
public partial class PayManage_VipPay_accountpaytest : System.Web.UI.Page
{
    public string par;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            string strLoginName = tzWeb.LoginInfo.GetLoginUserName(0);
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string posturl = OnlineStrike.alipayFormVIPList(orderNo, lblorderby_no.Text.ToString().Trim());
