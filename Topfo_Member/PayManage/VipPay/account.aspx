<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="account.aspx.cs" Inherits="PayManage_VipPay_account" Title="Untitled Page" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="account-3-td-r" style="height: 26px">支付密码：</td>
    <td class="account-3-td-l" style="height: 26px"><input name="" type="password" class="pawwword-input" id="txtPwd" runat="server" /></td>
  </tr>
  <tr>
    <td style="height: 32px">&nbsp;</td>
    <td style="padding-top:8px; height: 32px;"><%--<input name="" type="image" src="http://img2.topfo.com/img/payment2_11.jpg" />--%>
