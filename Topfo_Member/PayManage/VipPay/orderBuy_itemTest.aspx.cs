...
public partial class PayManage_VipPay_orderBuy_itemTest : System.Web.UI.Page
{
    public string par;
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Request.QueryString["order_no"] != null)
        {
            ...
            par = Request.QueryString["order_no"].Replace(" ", "+");
            orderNo = tzWeb.pay.comm.JieMi(par);
            Response.Redirect("accountpaytest.aspx?order_no=" + tzWeb.pay.comm.JiaMi(orderNo.ToString()) + "&Validate=" + Validate.ToString());
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else
        {
            if (Request.QueryString["order_no"] != null)
            {
                ...
                par = Request.QueryString["order_no"].Replace(" ", "+");
                orderNo = tzWeb.pay.comm.JieMi(par);
                Response.Redirect("accountTest.aspx?order_no=" + tzWeb.pay.comm.JiaMi(orderNo.ToString()) + "&Validate=" + Validate.ToString());
