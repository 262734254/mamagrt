<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    EnableEventValidation="false" CodeFile="ticket_trade_list.aspx.cs" Inherits="PayManage_ticket_trade_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="mainconbox">
        ...
        <div class="mycartbox">
            <div class="handtop">
                <ul>
                    <li><a href="trade_info_wait.aspx" style="text-decoration: none">我的购物车</a> </li>
                    <li><a href="trade_info_list.aspx">已付款交易</a></li><li class="liwai"><a href="ticket_trade_list.aspx">
                        购物券交易</a></li></ul>
            </div>
            ...
            <div class="con cshibiank">
                <div class="search">
                    <div class="lefts">
                        ...
                        <select id="ddluserType" name="select3" runat="server" style="display:none">
                    ...
                    <asp:Repeater runat="server" ID="myList">
                        ...
                        <AlternatingItemTemplate>
                            <tr class="tabb">
                                ...
                                <td  height="25" class="tabb" align=center>
                                     <%#GetTypeName(Eval("InfoTypeID"))%>
                                </td>
                                <td  class="tabb">
                                  <a href='http://www.topfo.com/<%#Eval("HtmlFile")%>' target="_blank" title="<%#Eval("Title")%>">
