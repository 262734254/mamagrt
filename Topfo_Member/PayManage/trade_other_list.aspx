    ...
    <div class="mainconbox">
        <div class="topzi">
            ...
            <div class="right" style="margin-bottom:13px;">
                <img src="http://member.topfo.com/images/hand_1_2.gif" alt="1" /> <a href="http://www.topfo.com/help/resourceswap.shtml" target="_blank" class="chenglink">
                    交易完全教程</a></div>
            <div class="clear">
            </div>
        </div>
        <div class="suggestbox allxian">
            ...
            <p>
                ...
                <asp:Literal ID="lblUserPoint" runat="server"></asp:Literal>元。
