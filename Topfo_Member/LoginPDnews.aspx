...
.channelLog{
	text-align:center;
	background-image: url(images/login/bcbgn.gif);
	width: 290px;
	margin-bottom: 8px;
}
.c_inpugt{width:90px;}
...
.btopt {
	background-image: url(images/login/btoptbgn.gif);
	background-repeat: no-repeat;
}
.atopt {
	background-image: url(images/login/abtopgbgn.gif);
	background-repeat: no-repeat;
...
.bbottomlg{
	background-image: url(images/login/bbottombgn.gif);
	background-repeat: no-repeat;
	height: 11px;
	overflow: hidden;
}
            ...
            <div class="padlg2">
			  <div style="padding:0 10px 0 15px ; text-align:left; height:30px; line-height:120%">
               ...
               <a href="" class="spaces"> <asp:ImageButton ID="imbLogin" runat="server" ImageUrl="images/login/buttom_dl.gif" OnClick="imbLogin_Click"
                    /></a>
                <a href="http://member.topfo.com/Register/Register.aspx" target="_blank" class="spaces"><img src="images/login/buttom_qx.gif" border="0" /></a> 
			</div>
