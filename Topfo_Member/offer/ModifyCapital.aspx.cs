...
public partial class offer_ModifyCapital : System.Web.UI.Page
{
    ...
    private void LoadInfo(long InfoID)
    {
        ...
        if (model.CapitalInfoModel != null)
        {
            ...
            this.txtHBao.Text = model.CapitalInfoModel.RegisteredCapital.ToString().Trim();
            //以下是需要添加的参数
            //注册资金
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        if (b)
        {
            ...
            Tz888.Common.MessageBox.ShowAndRedirect(this.Page, "修改投资资源失败！", "/Manage/ResourceManage_Pass.aspx");
