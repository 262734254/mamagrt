<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="publishCapital_step2.aspx.cs" Inherits="publishCapital_step2" Title="Untitled Page" %>
...
function check()
{
 ...
 if(document.getElementById("ctl00_ContentPlaceHolder1_txtGovName").value=="")
	    ...
	    if(document.getElementById("ctl00_ContentPlaceHolder1_txtMobile").value.length=="" )
        {
            alert("手机号码不能为空");
  ...
  <tr>
   ...
   <%--         <tr id="tr5" name="trswitchpublish">
      ...
      <asp:TextBox ID="ImageCode"  runat="server" Width="120px"></asp:TextBox> <img src="../ValidateNumber.aspx"  onclick="this.src='../ValidateNumber.aspx?temp=' + (new Date())" />
        ...
        <!--联系方式-->
        <div class="mbbuttom">
        <asp:Button  runat="server" Text="都填好了，立即发布"  class="setup" id="btn" OnClientClick="return check();"  OnClick="btn_ServerClick" />
            <%--<input type="button" value="都填好了，立即发布" class="setup" id="btn" runat="server" on  onserverclick="btn_ServerClick" />--%></div>
