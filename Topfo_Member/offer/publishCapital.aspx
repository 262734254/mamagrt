<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="publishCapital.aspx.cs" Inherits="offer_publishCapital" Title="Untitled Page" ValidateRequest="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <link href="css/member.css"rel="stylesheet" type="text/css" />
  <script src="js/yanz.js" type="text/javascript"></script>
   <style type="text/css">
...
//////////////////////////
    ...
    <div class="publication">
      ...
      <tr>
        ...
        <td><asp:TextBox ID="txtCapitalName" runat="server" onchange="JavaScrpit:CheckCapitalName()" Height="20px" Width="266px"></asp:TextBox>
    ...
    <tr>
      ...
      <input  type="text"   id="validCode" /> 
            ...
            <td colspan="2" id="pub-tongyi">
             ...
             <asp:ImageButton ID="IbtnSubmit"  OnClientClick="return chkpost();" ImageUrl="http://img2.topfo.com/member/images/member-btn-tj.jpg" runat="server"
