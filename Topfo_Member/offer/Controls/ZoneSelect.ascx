<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ZoneSelect.ascx.cs" Inherits="Tz888.Member.offer.Controls.offer_Controls_ZoneSelect" %>
<div class="left" style="width: 356px;">
    <select id="CountryListCN" style="width: 80px" onchange="javascript:changeCountry();"
        name="CountryListCN">
        <option selected="selected">中国</option>
    </select>
    <div id="AreaSpan" style="width: 254px; padding-top: 5px; display: inline; height: 1px;
        line-height: normal;">
        <select id="provinceCN" style="width: 78px" onchange="javascript:changeProvince();"
            name="provinceCN">
            <option selected="selected">省份</option>
        </select>
        <select id="capitalCN" style="width: 78px; margin-top: 4px;" onchange="javascript:changeCapital();"
            name="capitalCN">
            <option selected="selected">地级市</option>
        </select>
        <select id="cityCN" style="width: 83px; margin-top: 4px;" onchange="javascript:changeCounty();"
            name="cityCN">
    ...
    <table>
        <tr>
            <td valign="bottom">
                <input type="button" name="button" onclick="javascript:addZone();" id="button" value="添加&gt;&gt;" /></td>
            <td rowspan="2" valign="top" style="vertical-align: middle; height: 79px; text-align: center;
                width: 260px;">
        ...
        <tr>
            <td valign="top" class="llfloat60 mar20">
