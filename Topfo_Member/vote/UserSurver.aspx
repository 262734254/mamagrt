...
<p class="pcss">拓富·中国招商投资网（http://www.topfo.com）全新改版上线了！为了给您提供更好的服务，我们特开展此次用户服务需求调查活动，希望从中聆听到您宝贵的意见！完成全部调查问题的用户，皆能获得我们提供的精美礼品。</p>
<div class="blank0"></div>
<div class="icrbg" style="display:none;"><span class="orange02">建议您在参与调查之前，先了解一下新版有了哪些变化？</span> <span><a href="http://www.topfo.com/specialserve/serve03.shtml"  target="_blank" class="Ablue02">现在就去了解一下&gt;&gt;</a></span></div>

<div class="blank0"></div>

<div class="llnote">
<h3 class="f12"><span>活动时间：</span>2007年10月11日～2007年12月30日</h3>
<h3 class="f12"><span>活动规则：</span></h3>
<p>只要您按规定要求填写完问卷，并提交个人资料，就可以获得我们提供的参与奖一份（同一IP地址只计一次），并获得参与幸运大抽奖的资格。</p>
<p>幸运抽奖的中奖名单将在活动结束后统一公布，我们的客服会根据您留下的联系方式与您联络。本次活动的最终解释权归属于<a href="" target="_blank" class="Ared01">拓富·中国招商投资网</a>。</p>
<p>您的支持是我们前进的最大动力！</p>
</div>
...
<form action="http://www.topfo.com/vote/WebForm1.aspx?cid=40&do=redir" method="post" target="_blank" id="voteForm" onsubmit="return checkSelect()">
...
<div class="msgbox">
<div class="uerbg"><textarea name="" onclick="this.value=''" cols="" rows=""  class="uermsgbox">请直接输入您想说的话，祝福、批评或者建议都可以……</textarea></div>
...
<li class="li02"><input name="txtLinkName" type="text" class="inputcss2"/><span>请填写真实姓名，以便您获奖时与您联系</span>
<div class="clear"></div>
</li>
</ul>
...
<li class="li02"><input name="txtTel" type="text" class="inputcss2"/><span>手机或固定电话皆可，很重要！</span>
<div class="clear"></div>
</li>
</ul>
...
<li class="li02"><input name="txtEmail" type="text" class="inputcss2"/><span>请填写您最常用的邮箱，以便您获奖时给您发送邮件</span>
<div class="clear"></div>
</li>
</ul>
