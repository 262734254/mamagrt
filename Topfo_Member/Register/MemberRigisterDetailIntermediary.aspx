<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberRigisterDetailIntermediary.aspx.cs" Inherits="Register_MemberRigisterDetailIntermediary"  MasterPageFile="~/MasterPage.master" %>
    ...
    <div class="mainconbox">
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
            ...
            <tr>
                ...
                <td >
                    <span class="chengcu">
                        <asp:Label ID="lbManageType" runat="server">中介机构</asp:Label></span></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="height:35px;vertical-align:bottom">&nbsp;&nbsp;<strong style="font-size:large">中介方信息</strong>&nbsp;<span style="color:#c7c7c7">(可修改)</span></td>
            </tr>
            <tr>
                <td align="right" bgcolor="#F7F7F7">
                    <span class="hong">*</span> <strong>中介机构名称：</strong></td>
                <td >
