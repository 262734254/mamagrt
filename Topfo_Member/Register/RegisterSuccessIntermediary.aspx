<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterSuccessIntermediary.aspx.cs" Inherits="Register_RegisterSuccessIntermediary" %>
...
<div class="choose">
    ...
    <div class="bigclew clewbg">
		<p>您现在可享受以下服务：</p>
		<h4><a href="/#">登记公司信息</a> ，让投资方全面了解您的公司！</h4>
		<h4><a href="/#">发布需求</a> ，立即匹配对口资源！</h4>
...
<div class="hot"><strong>发布需求</strong><br />
  立即匹配对口资源</div>
...
<div class="rimg"><img src="../images/succe_14.jpg" width="19" height="19" /></div>
</div>--%>
<div class="tftong">
