...
public partial class Register_ValidEMailPersonal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Tz888.Common.MessageBox.ShowBack("邮箱验证出错！");
                return;
            }
            ...
            validurl = domain + Request.RawUrl.Replace("ValidEMailPersonal.aspx", "ValidSuccessPersonal.aspx");
