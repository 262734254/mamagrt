...
public partial class Register_MemberMessage_G : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["LoginName"] != null)
        {
            ...
            DataTable dt1 = obj1.GetLoginInfoList("*", "LoginName='" + LoginName + "'", "LoginName");//**********getLoginName
            //登记联系人
         ...
         //   DataTable dt5 = obj4.GetList("MainInfoViw", "Title,PublishT,HtmlFile", "PublishT", 1000, 1, 0, 1, "LoginName='" + LoginName + "'");
            //公司登记信息
            Tz888.BLL.Register.GovernmentRegisterBLL obj6 = new Tz888.BLL.Register.GovernmentRegisterBLL();
            DataTable dt6 = obj6.getGovernmentModel( LoginName);
            //公司附加信息
            ...
            if (dt1 != null || dt1.Rows.Count > 0)
            {
                ...
                if (model3 != null)
                {
                    ...
                    imgHead.ImageUrl = model3.HeadPortrait.ToString() != "" ? ConfigurationManager.AppSettings["ImageDomain"].ToString() + "/" + model3.HeadPortrait : "../images/MemberData/nopic.gif";
                }
                if (model2 != null)
                {
                ...
                //RepeaterPublish.DataSource = dt5;
                if (dt6 != null)
                {
    ...
    {
        Response.Write("<script>window.open('/helper/FriendFore.aspx');</script>");
    }
}
