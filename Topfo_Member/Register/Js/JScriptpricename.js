  ...
  if(document.getElementById ("ctl00_ContentPlaceHolder1_txtCapitalTitle").value.length==0)
      ...
      if(document.getElementById ("ctl00_ContentPlaceHolder1_txtCapitalIntent").value.length==0)
   {
     ...
     return false;
        ...
        if(document.getElementById ("ctl00_ContentPlaceHolder1_txtenpricename").value.length==0)
     {
       document.getElementById ("showenpricename").innerHTML="*";
       document.getElementById ("showenpricename").style .display ="inline";
       document.getElementById ("ctl00_ContentPlaceHolder1_txtenpricename").focus();
       return false;
      }
