...
ChineseName: 用户名称,
EnglishName: 英文名称,
UserName: 验证用户名,字母开头，允许4-16字节，允许字母数字下划线,
...
function FieldValidate(ctl) {
    ...
    var UserName = /^[a-zA-Z0-9_]{4,16}$/; //验证用户名必须5-20个字符
    var Password = /\w{6,20}/;  //至少输入5-20个字符
...
var bankid_error = "您必须输入19位整数!";
    ...
    var UserName_error = "用户名必须4-16个字符!";
    var Password_error = "密码必须6-20个字符!";
