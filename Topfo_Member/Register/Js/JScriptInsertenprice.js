 ...
 //验证码验证
      ...
      if(document.getElementById ("ctl00_ContentPlaceHolder1_txtCapitalIntent").value.length==0)
   {
     ...
     return false;
        ...
        if(document.getElementById ("ctl00_ContentPlaceHolder1_txtentriname").value.length==0)
     {
       document.getElementById ("showentiypename").innerHTML="*";
       document.getElementById ("showentiypename").style .display ="inline";
       document.getElementById ("ctl00_ContentPlaceHolder1_txtentriname").focus();
       return false;
      }
