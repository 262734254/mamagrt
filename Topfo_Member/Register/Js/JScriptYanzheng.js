// JScript 文件
 ...
 function chkPost()
{
       var s=document.getElementById("ctl00_ContentPlaceHolder1_txtemail").value;
     if(document.getElementById ("ctl00_ContentPlaceHolder1_txtloginName").value.length<4&&document.getElementById ("ctl00_ContentPlaceHolder1_txtloginName").value.length>0)
   {
   ...
   if(document.getElementById ("ctl00_ContentPlaceHolder1_txtloginName").value.length==0)
   {
    ...
    if(document.getElementById ("ctl00_ContentPlaceHolder1_txtpassword").value.length<6&&document.getElementById ("ctl00_ContentPlaceHolder1_txtpassword").value.length>0)
   {
   ...
   if(document.getElementById ("ctl00_ContentPlaceHolder1_txtpassword").value!=document.getElementById ("ctl00_ContentPlaceHolder1_txtpassWords").value)
   {
     document.getElementById ("showpasses").innerHTML="输入的密码不一致";
     document.getElementById ("showpasses").style .display ="inline";
     document.getElementById ("ctl00_ContentPlaceHolder1_txtpassWords").focus();
     return false;
   }
   if(document.getElementById ("ctl00_ContentPlaceHolder1_txtMoblie").value.length==0&&document.getElementById ("ctl00_ContentPlaceHolder1_txtTel").value.length==0)
   {
     document.getElementById ("showTel").innerHTML="手机和电话至少填一个";
     document.getElementById ("showTel").style .display ="inline";
      document.getElementById ("ctl00_ContentPlaceHolder1_txtMoblie").focus();
     return false;
   }
      if(document.getElementById ("ctl00_ContentPlaceHolder1_txtMoblie").value.length>0&&document.getElementById ("ctl00_ContentPlaceHolder1_txtMoblie").value.length<11)
   {
    ...
    }    if(document.getElementById ("ctl00_ContentPlaceHolder1_txtyanzheng").value.length==0)
   {
     document.getElementById ("showyanzheng").style .display ="inline";
     document.getElementById ("ctl00_ContentPlaceHolder1_txtyanzheng").focus();
     return false;
   }      if(document.getElementById("ctl00_ContentPlaceHolder1_txtyanzheng").value.toUpperCase()!=document.getElementById("checkCode").value)
     {
