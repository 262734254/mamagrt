<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidEMailGov.aspx.cs" Inherits="Register_ValidEMailGov" %>
...
<div class="content">
	...
	<div class="clewbox">
	    ...
	    <h1>第一步：查收验证信</h1>
      <h2>
          我们已发送验证信到：<asp:Label ID="lblMail" runat="server"></asp:Label><br />
	...
	<div class="bigclew"  style="display:none">
		...
		<div class="item">
		<h5>免费推广招商机构 </h5>
		<h6>免费登记您的招商机构，创建网上展厅，让60多万会员关注您！</h6>
		</div>
		<div class="clear"></div>
	</div>
	<div class="bigclew"  style="display:none"s>
