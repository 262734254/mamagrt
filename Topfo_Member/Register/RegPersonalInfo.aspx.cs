...
public partial class Register_RegPersonalInfo : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
       ...
       loginName = this.usrname.Value;
        ...
        try
        {
            ...
            string ValidUrl = "ValidSuccessPersonal.aspx?email=" + encryEmail + "&logname=" + encryLogname+"&act="+act;
