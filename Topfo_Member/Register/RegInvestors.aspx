<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegInvestors.aspx.cs" Inherits="Register_RegInvestors" %>
...
<body>
    ...
    <form id="frm" method="post" runat="server" action="RegInvestors.aspx">
        <div class="content">
            <div class="content_top">
                <div class="clew">
                    <h4>
                        您选择的会员身份是<font color="#FF6600">投资方</font>！</h4>
                    <br />
                    注册后您可以发布投资意向、加入投资机构黄页、查询项目资源等。 <a href="Register.aspx">重新选择会员类型</a>
                </div>
            </div>
            <div class="line_text">
                <div class="ltxt">
                ...
                <table width="742" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="t_title">
                            投资方类型：</td>
                        <td align="left">
                            <input type="radio" name="propertyid" value="0" checked="checked" />
                            投资机构<input type="radio" name="propertyid" value="1" />
                            个人投资者</td>
                    </tr>
                </table>
            </div>
