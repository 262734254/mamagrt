<%@ Page Language="C#" MasterPageFile="~/Retrieve.master" Title="找回密码 拓富—中国招商投资网" AutoEventWireup="true" CodeFile="RetrieveStep6.aspx.cs" Inherits="Register_RetrieveStep6"%>
...
<div style="text-align: right" ><a href="RetrieveStep5.aspx">返回上一页</a></div>
...
<div class="inforbox wi800 bgimg08">

<div class="blank0"></div><div class="blank20"></div>


<div class="pL180">
<p><b>对不起，您输入的答案与您设置的密码保护问题答案不一致，请重新输入！</b></p>
<div class="blank0"></div>
