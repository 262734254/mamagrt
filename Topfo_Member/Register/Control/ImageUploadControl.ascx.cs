...
namespace Tz888.Member.Register.Controls
{
    public partial class ImageUploadControl : System.Web.UI.UserControl
    {
        ...
        private string memberInfoModel = "<span class='hui'>您现在可以上传<span class='hong'>{0}</span>张展示机构的图片，图片须为jpg或gif格式，大小不超过500k。</span>";

        private string _uploadImageURL = "./p_upload_picture.aspx";
        ...
        private List<Tz888.Model.MemberResourceModel> _infoList = new List<Tz888.Model.MemberResourceModel>();
        ...
        /// 上传图片的集合
        /// </summary>
        public List<Tz888.Model.MemberResourceModel> InfoList
        {
            get
            {
                for (int i = 0; i <= this.NoneCount; i++)
                {
                    ...
                    if (this.Page.Request.Form[isloadControlID] != null)
                    {
                        ...
                        if (isLoad == "Y")
                        {
                            ...
                            model.ResourceProperty = (int)Tz888.Common.MemberResourceProperty.RP0;
        ...
        private string CreateControlCode()
        {
            ...
            if (this.Count > 0)
            {
                ...
                if (this.Count > 0)
                {
                    ...
                    {
                        foreach (Tz888.Model.MemberResourceModel model in this._infoList)
                        {
