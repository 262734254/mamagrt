<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ImageUploadControl.ascx.cs"
    Inherits="Tz888.Member.Register.Controls.ImageUploadControl" %>
<style type="text/css">
.divuploadimg ul{
	padding: 0 0 0 0;
}
...
UploadPic.prototype.uploadnodoor = function(){
    if(confirm('只有拓富通会员才可以上传多张产品图片。您希望现在就升级为拓富通会员吗？')){
...
UploadPic.prototype.showupload = function(id)
{
    ...
    var iframe = '<iframe id="iframe1" style="width:100%;height:160px;" src="UploadURL" marginwidth=0 marginheight=0 frameborder=0></iframe>';
