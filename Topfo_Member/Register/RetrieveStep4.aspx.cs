...
public partial class Register_RetrieveStep4 : System.Web.UI.Page
{
            ...
            if (strmail.Trim().Length > 0)
            {
                if (strmail == mail)
                {
                    ...
                    try
                    {
                        ...
                        string validurl = domain + Request.RawUrl.Replace("RetrieveStep4.aspx", "RetrieveStep3.aspx");
                ...
                {
                   this.LblMessage.Text="请您把注册时使用的邮箱地址填写正确！";
                }
            }
        }
        catch
