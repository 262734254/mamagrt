...
using Tz888.Common;
using Tz888.BLL;
public partial class Register_MemberRigisterDetailGov : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtNickName.Value = model3.NickName.ToString(); //昵称
    ...
    protected void IbtnSubmit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string NickName = txtNickName.Value;
        ...
        modelInfo3.NickName = txtNickName.Value;   //昵称
