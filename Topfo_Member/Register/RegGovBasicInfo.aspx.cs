...
public partial class Register_RegGovBasicInfo : System.Web.UI.Page
{
    ...
    private void sdt()
    {
        ...
        model.CompanyName = this.contactname.Value;
        ...
        memberModel.ContactTitle = this.contacttitle.Value.ToString().Trim(); //招商机构名称
