<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberRigisterDetailProject.aspx.cs" Inherits="Register_MemberRigisterDetailProject" MasterPageFile="~/MasterPage.master" %>
    ...
    <div class="mainconbox">
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
            ...
            <tr>
                ...
                <td >
                    <span class="chengcu">
                        <asp:Label ID="lbManageType" runat="server">项目方</asp:Label></span></td>
            </tr>
            <tr>
...
<script src="../js/Ajax.js" language="javascript" type="text/javascript"></script>
    ...
    if(!($('ctl00_ContentPlaceHolder1_lbManageType').innerText=='项目方'))
    {
