<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegIntermediary.aspx.cs"
    Inherits="Register_RegIntermediary" Debug="true" %>
...
<body>
    ...
    <form id="frm" method="post" runat="server" action="RegIntermediary.aspx">
        <div class="content">
            <div class="content_top">
                <div class="clew">
                    <h4>
                        您选择的会员身份是<font color="#FF6600">中介机构</font>！</h4>
                    <br />
                    注册后您可以发布政府招商需求、投资需求、融资需求、查询对口资源等。 <a href="Register.aspx">重新选择会员类型</a>
                </div>
            </div>
            <div class="line_text">
                <div class="ltxt">
