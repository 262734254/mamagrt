<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegEnterpriseInfo.aspx.cs"
    Inherits="Register_RegEnterpriseInfo" %>
...
<head runat="server">
    <title>填写基本信息－－企业会员</title>
    <link href="../css/regstep.css" rel="stylesheet" type="text/css" />

    <script src="/member/ajaxpro/prototype.ashx" type="text/javascript"></script>

    <script src="/member/ajaxpro/core.ashx" type="text/javascript"></script>

    <script src="/member/ajaxpro/converter.ashx" type="text/javascript"></script>

    <script src="/member/ajaxpro/Tz888.Common.Ajax.AjaxMethod,Tz888.Common.ashx" type="text/javascript"></script>
...
<body>
    ...
    <form id="frm" action="#" method="post" runat="server" onsubmit="return CheckAll()">
        <div class="content">
            <div class="content_top">
                <div class="clew">
                    <h4>
                        您选择的是企业会员！<span><a href="register.aspx">重新选择会员类型</a></span></h4>
                    <h6>
            ...
            <table width="0" border="0" class="inputtable">
                ...
                <tr>
                    <th>
                        <span>*</span>密码：</th>
                    <td>
                        <input name="pwd" id="pwd" type="password" runat="server" /></td>
                    <td>
                        <div class="commonly" id="pwdinfo">
                            密码由6-20个英文字母或数字组成，建议采用易记、难猜的英文数字组合。<a href="AgreeMent.shtml" target="_blank">&gt;&gt;如何设置安全的密码</a></div>
                    </td>
                </tr>
                <tr>
                    <th>
                        <span>*</span>重复输入密码：</th>
                    <td>
                        <input name="repwd" id="repwd" type="password" runat="server" /></td>
                    <td>
                ...
                <tr>
                    <th>
                        <span>*</span>昵称：</th>
                    <td>
                        <input name="nikemame" id="nikename" type="text" runat="server" /></td>
                    <td>
                ...
                <tr>
                    <th>
                        <span>*</span>电子邮箱：</th>
                    <td>
                        <input name="email" id="email" type="text" runat="server" /></td>
                    <td>
            ...
            <div style="padding-left: 120px; float: left; padding-top: 8px">
                <span style="color: red">*</span>固定电话和手机请您至少填写一项</div>
            <div style="clear: both">
            </div>
            <table width="0" border="0" class="inputtable">
                <tr>
                ...
                <tr>
                    <th>
                        手机：</th>
                    <td style="width: 247px">
                        <input name="mobile" id="mobile" type="text" runat="server" /></td>
                    <td>
            ...
            <table width="0" border="0" class="inputtable">
                <tr>
                    ...
                    <td>
                        <div class="commonly" id="comnameinfo">
                            公司名称由3个以上英文字母和中文 或 3个以上中文组成</div>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="commonly" id="addressinfo">
                            请用中文填写真实、准确的地址</div>
                    </td>
                </tr>
        ...
        <div class="tijiao">
            <p>
                ...
                我已阅读并同意<a target="_blank" href="http://www.topfo.com/Register/AgreeMent.shtml">《中国招商投资网服务协议》</a><span
