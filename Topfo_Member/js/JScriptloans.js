 ...
 function chkPost()
{
     ...
     if(document.getElementById ("ctl00_ContentPlaceHolder1_txtloginName").value.length<4&&document.getElementById ("txtloginName").value.length>0)
   {
    ...
    if(document.getElementById ("ctl00_ContentPlaceHolder1_txtyanzheng").value.length==0)
   {
     ...
     return false;
      ...
      if(document.getElementById("ctl00_ContentPlaceHolder1_txtyanzheng").value.toUpperCase()!=document.getElementById("ctl00_ContentPlaceHolder1_checkCode").value)
     {
