...
public partial class AdUnion_Ad_InfoHit : Tz888.Common.Pager.BasePage
{
    ...
    public void bind()
    {
        ...
        try
        {
            DataTable dt = bll.GetList("eachothermemberlistView", "OrderNo", "*", strWhere, " ConsumeTime desc", ref CurrPage, PageSize, ref TotalCount);
