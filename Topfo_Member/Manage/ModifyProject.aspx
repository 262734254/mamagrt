<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ModifyProject.aspx.cs" ValidateRequest="false" Inherits="Manage_ModifyProject" Title="Untitled Page" %>
    ...
    <div class="mainconbox">
        <div class="titled">
            ...
            <div class="right">
                ...
                <a href="http://www.topfo.com/help/demandrelease.shtml#16" target="_blank">需求发布案例</a> 
            </div>
            <div class="clear">
            </div>
        </div>
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="tabbiank">
            ...
            <tr id="tr2" name="trswitchpublish">
                ...
                <td width="630" valign="top" class="nonepad">
                    <uc3:ImageUploadControl ID="ImageUploadControl1" runat="server" InfoType="Project"/>
              </td>
            </tr>
            <tr>
                ...
                <td width="630" valign="top" style="height: 71px">
                   <textarea id="txtProIntro" onchange="checkProIntro();"  runat="server" cols="50" rows="10" style="width: 558px;
                            height:300px"></textarea></span><span id="spProIntro"><br />
        ...
        <div class="blank0">
          ...
          <!--附加信息 -->
        <div class="infozi" style="display:none;">
            附加信息</div>
        <div style="display:none;">
        <uc4:FileUpLoadControl ID="FileUpLoadControl1" runat="server" /></div>
        <div class="blank0">
        </div>
        ...
        <div class="mbbuttom">
            <asp:Button ID="btnUpdate" runat="server" Text="修 改" OnClick="btnUpdate_Click" Width="144px" CssClass="buttomal" /></div>
    </div>
</asp:Content>
