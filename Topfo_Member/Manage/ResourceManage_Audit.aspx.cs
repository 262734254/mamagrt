...
public partial class ResourceManage_Audit : Tz888.Common.Pager.BasePage
{
    ...
    private void SetPagerParameters()
    {
       ...
       string loginName = Page.User.Identity.Name;
        //string loginName = "bettylee";
        if (ViewState["Criteria"] == null)
        {
            this._criteria = "LoginName = '" + loginName + "' And InfoOriginRoleName = '0'  And DelStatus <> 1 And OverdueFlag <> 1 And AuditingStatus = " + ((int)Tz888.BLL.Common.AuditStatus.Auditing).ToString() + " and InfoTypeID in ('Merchant','Project','Capital','CarveOut','Oppor')";
    ...
    protected string GetRemind()
    {
       ...
       //string loginName = "bettylee";
        Tz888.BLL.Info.MainInfoBLL bll = new Tz888.BLL.Info.MainInfoBLL();
        return bll.GetRemind(loginName,"0" ,this.remindModel, Tz888.BLL.Common.AuditStatus.Auditing);
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
       ...
       string loginName = Page.User.Identity.Name;
        //string loginName = "bettylee";
       this._criteria = "LoginName = '" + loginName + "' And InfoOriginRoleName = '0' And DelStatus <> 1 And OverdueFlag <> 1 And AuditingStatus = " + ((int)Tz888.BLL.Common.AuditStatus.Auditing).ToString();
