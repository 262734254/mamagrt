...
public partial class Subject_SubjectRecordSee : System.Web.UI.Page
{
    ...
    private void DataBind()
    {
        ...
        ComID.Value=Convert.ToString(sub);
        ...
        DataTable dt = subBll.GetListT("SubjectRecordTab", "RecordID", "*", strCriteria, "RecordID desc", ref CurrentPage, PageNum, ref TotalCount);
        if (dt != null)
        {
