<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExtendAddressSee.aspx.cs" Inherits="Subject_ExtendAddressSee" Title="Untitled Page" %>
...
<div  id="divId" runat="server" >
        <h2>
        <ul>
         <li class="btn_on"  id="sh_btn_1">推广位置信息</li>
