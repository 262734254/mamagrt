...
public partial class Manage_ModifyCapital : System.Web.UI.Page
{
    ...
    private void LoadInfo(long InfoID)
    {
        ...
        this.txtGovIntro.Value = Tz888.Common.Utility.PageValidate.FiltrateHTMLTag(Tz888.Common.Utility.PageValidate.HtmlToTxt(model.InfoContactModel.OrgIntro));
        ...
        if (model.CapitalInfoModel != null)
        {
            ...
            //this.ZoneSelectControl1.CapitalInfoAreaModels = model.CapitalInfoAreaModels;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        //model.CapitalInfoAreaModels = this.ZoneSelectControl1.CapitalInfoAreaModels;
        ...
        model.CapitalInfoModel.ComBreif = "";
        ...
        //这里是换为投资机构名称
        model.InfoContactModel.OrganizationName = this.txtGovName.Text;
        model.InfoContactModel.OrgIntro = Tz888.Common.Utility.PageValidate.TxtToHtml(this.txtGovIntro.Value);
