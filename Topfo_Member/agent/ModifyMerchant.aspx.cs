...
public partial class Manage_ModifyMerchant : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        //项目优势及市场分析
        model.MerchantInfoModel.Market = Tz888.Common.Utility.PageValidate.TxtToHtml(txtMarket.Text.Trim());
        //地方经济指标描述
        model.MerchantInfoModel.EconomicIndicators = Tz888.Common.Utility.PageValidate.TxtToHtml(txtEconomicIndicators.Text.Trim());
        //投资环境描述
        model.MerchantInfoModel.InvestmentEnvironment = Tz888.Common.Utility.PageValidate.TxtToHtml(txtInvestmentEnvironment.Text.Trim());
        //经济效益分析
        model.MerchantInfoModel.Benefit = Tz888.Common.Utility.PageValidate.TxtToHtml(txtBenefit.Text.Trim());
        ...
        if (!string.IsNullOrEmpty(this.MerchantInfoAddressInfo1.Undertaker))
            model.MerchantInfoModel.ReceiveOrganization = Tz888.Common.Utility.PageValidate.FiltrateHTMLTag(this.MerchantInfoAddressInfo1.Undertaker.Trim());
        else
