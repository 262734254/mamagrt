<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Attention.aspx.cs" Inherits="Access_Attention" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<script type="text/javascript" src="../js/jquery.js" ></script>
<script language="javascript" type="text/javascript" >
//绑定内容
function Hand(name,page,type)
{
   $.ajax({type:"post",url:"AjaxAtten.ashx",data:"InfoType="+type+"&name="+name+"&Type=1&Page="+page,success:function(msg) 
   {
...
//绑定分页
function PageIndex(name,page,type)
{
   $.ajax({type:"post",url:"AjaxAtten.ashx",data:"InfoType="+type+"&name="+name+"&Type=2&Page="+page,success:function(msg) 
   { 
...
{
var name=document.getElementById("ctl00_ContentPlaceHolder1_LoginName").value;
var b = document.getElementById("<%=ddltype.ClientID %>");
   var type = b.options[b.selectedIndex].value;
   Hand(name,page,type);
   PageIndex(name,page,type);
}
...
<input runat="server" type="hidden" id="LoginName" />
<div class="member-right">
    <div class="publication">
      <h1><span class="fl"><span class="f_14px strong f_cen">我发布的信息</span></span><span class="fr"><img src="http://img2.topfo.com/member/images/biao_01.gif" align="absmiddle"/> <a href="#" class="publica-fbxq">需求发布规则</a></span></h1>
   ...
   <input type="button" class="btn-002" value="查询" onclick="Having(0);" />
   </div>
