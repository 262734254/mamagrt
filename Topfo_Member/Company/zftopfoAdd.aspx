<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="zftopfoAdd.aspx.cs" Inherits="Company_zftopfoAdd" Title="Untitled Page" ValidateRequest="false" %>
 ...
 return str;
    ...
    <div class="member-right">
        <div class="publication">
            <h1>
                <span class="fl"><span class="f_14px strong f_cen" runat="server" id="txtTop">专业服务拓富通申请</span>(带<span
