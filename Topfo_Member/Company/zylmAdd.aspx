<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="zylmAdd.aspx.cs" Inherits="Company_zylmAdd" Title="Untitled Page" %>
 ...
 return str;
    ...
    <div class="member-right">
        <div class="publication">
            <h1>
                <span class="fl"><span class="f_14px strong f_cen" runat="server" id="txtTop">资源联盟申请</span>(带<span
