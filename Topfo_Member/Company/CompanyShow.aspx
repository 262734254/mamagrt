<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CompanyShow.aspx.cs" Inherits="Company_CompanyShow" Title="Untitled Page" ValidateRequest="false" %>
 ...
 return str;
    ...
    <div class="member-right">
        <div class="publication">
            <h1>
                <span class="fl"><span class="f_14px strong f_cen" runat="server" id="txtTop">投资拓富通申请</span>(带<span
