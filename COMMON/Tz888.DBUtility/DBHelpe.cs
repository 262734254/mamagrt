...
namespace Tz888.DBUtility
{
   ...
   //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        ...
        /// <param name="tableName">DataSet结果中的表名</param>
        /// <returns>DataSet</returns>
        public static DataSet RunProcedureT(string storedProcName, IDataParameter[] parameters, string tableName)
        {
            using (SqlConnection connection = new SqlConnection(UnionConnString))
            {
                try
        ...
        /// <param name="rowsAffected">影响的行数</param>
        /// <returns></returns>
        public static int RunProcedureT(string storedProcName, IDataParameter[] parameters, out int rowsAffected)
        {
            using (SqlConnection connection = new SqlConnection(UnionConnString))
            {
                int result;
        ...
        /// <param name="rowsAffected">影响的行数</param>
        /// <returns></returns>
        public static int RunProcedure3(string storedProcName, IDataParameter[] parameters, out int rowsAffected)
        {
        ...
        /// <param name="tableName">DataSet结果中的表名</param>
        /// <returns>DataSet</returns>
        public static DataSet RunProcedure3(string storedProcName, IDataParameter[] parameters, string tableName)
        {
            using (SqlConnection connection = new SqlConnection(connectionString3))
            {
                try
        ...
        /// <param name="prams">对于存储过程有输入参数的数组</param>
        /// <returns></returns>
        public static bool RunProcLob3(
            string procName,
            SqlParameter[] prams)
        {
            bool blret = false;
