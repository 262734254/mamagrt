...
namespace Tz888.Pager
{
    ...
    public class AspNetPager : Panel, INamingContainer, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (null != CloneFrom && string.Empty != CloneFrom.Trim())
            {
                ...
                if (null == ctrl)
                {
                    ...
                    if (null == errStr)
                        errStr = "The control \" %controlID% \" does not exist or is not of type Tz888.Pager.AspNetPager!";
        ...
        public override void RenderBeginTag(HtmlTextWriter writer)
        {
            ...
            writer.WriteLine();
            writer.Write("<!-- ");
            writer.Write("·ÖÒ³£º" + ver + " for VS2005  Copyright:2007 tz888.pager");
            writer.WriteLine(" -->");
            if (!showPager)
            {
                writer.Write("<!--");
        ...
        public override void RenderEndTag(HtmlTextWriter writer)
        {
            ...
            writer.WriteLine();
            writer.Write("<!-- ");
            writer.Write("·ÖÒ³ V" + ver + " for VS2005 End");
            writer.WriteLine(" -->");
            writer.WriteLine();
        }
    ...
    internal sealed class SR
    {
        private SR()
        {
            _rm = new System.Resources.ResourceManager("Tz888.Pager.AspNetPager",base.GetType().Assembly);
        }
